                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/authdto.SigninDTO"
                        }
                    }
                ],
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/authdto.SigninOutputDTO"
                        }
                    },
                    "400": {
                        "description": "Bad Request",
    ...
    "definitions": {
        ...
        "ent.Verification": {
            ...
            "properties": {
                ...
                "expired_at": {
                    "description": "ExpiredAt holds the value of the \"expired_at\" field.",
                    "type": "string"
                },
                "id": {
                    "description": "ID of the ent.",
