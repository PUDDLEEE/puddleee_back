...
import (
	...
	"github.com/PUDDLEEE/puddleee_back/ent/migrate"
...
// QueryRooms queries the rooms edge of a Category.
func (c *CategoryClient) QueryRooms(ca *Category) *RoomQuery {
	...
	query.path = func(context.Context) (fromV *sql.Selector, _ error) {
		...
		step := sqlgraph.NewStep(
			...
			sqlgraph.Edge(sqlgraph.O2M, false, category.RoomsTable, category.RoomsColumn),
		)
...
func (c *MessageClient) QueryRoom(m *Message) *RoomQuery {
	...
	query.path = func(context.Context) (fromV *sql.Selector, _ error) {
		...
		step := sqlgraph.NewStep(
			...
			sqlgraph.To(room.Table, room.FieldID),
			sqlgraph.Edge(sqlgraph.M2M, true, message.RoomTable, message.RoomPrimaryKey...),
		)
...
// QueryQuestioner queries the questioner edge of a Room.
func (c *RoomClient) QueryQuestioner(r *Room) *UserQuery {
	query := (&UserClient{config: c.config}).Query()
	query.path = func(context.Context) (fromV *sql.Selector, _ error) {
		id := r.ID
		step := sqlgraph.NewStep(
...
// QueryRespondent queries the respondent edge of a Room.
func (c *RoomClient) QueryRespondent(r *Room) *UserQuery {
	query := (&UserClient{config: c.config}).Query()
	query.path = func(context.Context) (fromV *sql.Selector, _ error) {
		id := r.ID
		step := sqlgraph.NewStep(
...
// QueryCategory queries the category edge of a Room.
func (c *RoomClient) QueryCategory(r *Room) *CategoryQuery {
...
// QueryViews queries the views edge of a Room.
func (c *RoomClient) QueryViews(r *Room) *ViewQuery {
...
// QueryOwnRooms queries the own_rooms edge of a User.
func (c *UserClient) QueryOwnRooms(u *User) *RoomQuery {
	query := (&RoomClient{config: c.config}).Query()
	query.path = func(context.Context) (fromV *sql.Selector, _ error) {
		id := u.ID
		step := sqlgraph.NewStep(
...
// QueryParticipantRooms queries the participant_rooms edge of a User.
func (c *UserClient) QueryParticipantRooms(u *User) *RoomQuery {
	query := (&RoomClient{config: c.config}).Query()
	query.path = func(context.Context) (fromV *sql.Selector, _ error) {
		id := u.ID
		step := sqlgraph.NewStep(
...
// QueryRoom queries the room edge of a View.
func (c *ViewClient) QueryRoom(v *View) *RoomQuery {
	query := (&RoomClient{config: c.config}).Query()
	query.path = func(context.Context) (fromV *sql.Selector, _ error) {
		id := v.ID
		step := sqlgraph.NewStep(
