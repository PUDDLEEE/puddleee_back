...
// QueryMessage queries the message edge of a Room.
func (c *RoomClient) QueryMessage(r *Room) *MessageQuery {
...
type (
	hooks struct {
		Message, Room, User, View []ent.Hook
	}
	inters struct {
		Message, Room, User, View []ent.Interceptor
	}
)
