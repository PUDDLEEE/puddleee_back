...
func (vq *VerificationQuery) IDs(ctx context.Context) (ids []int, err error) {
...
//		GroupBy(verification.FieldCreateTime).
//		Aggregate(ent.Count()).
//		Scan(ctx, &v)
...
//
//	client.Verification.Query().
//		Select(verification.FieldCreateTime).
//		Scan(ctx, &v)
...
func (vq *VerificationQuery) querySpec() *sqlgraph.QuerySpec {
	_spec := sqlgraph.NewQuerySpec(verification.Table, verification.Columns, sqlgraph.NewFieldSpec(verification.FieldID, field.TypeInt))
	_spec.From = vq.sql
