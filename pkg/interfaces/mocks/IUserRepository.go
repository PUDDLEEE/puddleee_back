...
func (_m *IUserRepository) Create(_a0 context.Context, _a1 *ent.Client, _a2 userdto.CreateUserDTO) (*ent.User, error) {
	...
	var r0 *ent.User
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, *ent.Client, userdto.CreateUserDTO) (*ent.User, error)); ok {
		return rf(_a0, _a1, _a2)
	}
	if rf, ok := ret.Get(0).(func(context.Context, *ent.Client, userdto.CreateUserDTO) *ent.User); ok {
		r0 = rf(_a0, _a1, _a2)
	} else {
		if ret.Get(0) != nil {
	...
	if rf, ok := ret.Get(1).(func(context.Context, *ent.Client, userdto.CreateUserDTO) error); ok {
		r1 = rf(_a0, _a1, _a2)
	} else {
		r1 = ret.Error(1)
	}
...
func (_m *IUserRepository) Update(_a0 context.Context, _a1 *ent.Client, _a2 int, _a3 userdto.UpdateUserDTO) (*ent.User, error) {
	...
	var r0 *ent.User
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, *ent.Client, int, userdto.UpdateUserDTO) (*ent.User, error)); ok {
		return rf(_a0, _a1, _a2, _a3)
	}
	if rf, ok := ret.Get(0).(func(context.Context, *ent.Client, int, userdto.UpdateUserDTO) *ent.User); ok {
	...
	if rf, ok := ret.Get(1).(func(context.Context, *ent.Client, int, userdto.UpdateUserDTO) error); ok {
